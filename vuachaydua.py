...
AQUA = "\033[96m"
LIME = "\033[92m"
                                                                # Danh sách các tên viết tắt và tên đầy đủ
phong = {
    "BẬT THẦY": "BT",
    "QUYỀN SẮT": "QS",                                              
    "THỢ LẶN": "TL",
...
def hien_thi_danh_sach_phong():
    ...
    print(f"{BOLD}{AQUA}DANH SÁCH  VIẾT TẮT TOOL VIP MINH HÒA:{RESET}")
...
def hien_thi_intro():
    ...
    intro_messages = [
        ...
        "Nhập số lần về đích của mỗi nhân vật trong 100 trận gần đây❗"
...
while True:
    phong_satt_thu_da_vao = input (" Nhập số lần về đích của mỗi nhân vật trong 100 trận gần đây (ADMIN MINH HÒA)🃏: ").strip()
